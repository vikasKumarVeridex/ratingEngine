...
(function (g) {
  ...
  D.lookupTables = [
    { id: 1, name: "ZIP → Territory (Trucking)", lob: "Commercial Trucking", keys: "ZIP", rows: 57086, source: "ZIPCodes", version: "v2026.03" },
    { id: 2, name: "Increased Limits Factors", lob: "Commercial Trucking", keys: "State + Table + Limit", rows: 5217, source: "IncreasedLimitsFactors", version: "v2026.03" },
    { id: 3, name: "Liability Loss Costs", lob: "Commercial Trucking", keys: "State + Terr + VehType + Cov", rows: 1955, source: "CA_Liab_LC", version: "v2026.03" },
    { id: 4, name: "Garagekeepers Rates", lob: "Commercial Trucking", keys: "State + Limit + Coverage", rows: 1621, source: "CA_GKL", version: "v2026.03" },
    { id: 5, name: "PhysDam Rates by TIV", lob: "Commercial Trucking", keys: "Stated Value + Deductible", rows: 300, source: "PhysDamRatesByTIV", version: "v2026.03" },
    { id: 6, name: "GL Additional Parameters", lob: "General Liability", keys: "State + Class + Coverage", rows: 236054, source: "AdditionalParameters", version: "v2025.10" },
    { id: 7, name: "GL Prem/Ops Loss Costs", lob: "General Liability", keys: "State + Class Code", rows: 186556, source: "PremOpsLossCosts", version: "v2025.10" },
    { id: 8, name: "GL Products Loss Costs", lob: "General Liability", keys: "State + Class Code", rows: 23247, source: "ProductsLossCosts", version: "v2025.10" },
    { id: 9, name: "GL Increased Limits Factors", lob: "General Liability", keys: "State + Limit", rows: 22465, source: "ILF", version: "v2025.10" },
    { id: 10, name: "GL ZIP Code", lob: "General Liability", keys: "ZIP", rows: 57774, source: "ZipCode", version: "v2025.10" },
    { id: 11, name: "GL ILTA Table", lob: "General Liability", keys: "Class + Table", rows: 1917, source: "ILTA", version: "v2025.10" },
    { id: 12, name: "GL Sectors", lob: "General Liability", keys: "NAICS Sector", rows: 1991, source: "Sectors", version: "v2025.10" },
    { id: 13, name: "Property BG1 Rates", lob: "Commercial Property", keys: "State + Class + Constr + PPC", rows: 61360, source: "CP_BG1", version: "v2026.01" },
    { id: 14, name: "Property SCL ZIP", lob: "Commercial Property", keys: "ZIP", rows: 63089, source: "ZipCode_SCL", version: "v2026.01" },
    { id: 15, name: "Property BG2 ZIP", lob: "Commercial Property", keys: "ZIP", rows: 47145, source: "ZipCode_BG2", version: "v2026.01" },
    { id: 16, name: "Property BG1 ZIP", lob: "Commercial Property", keys: "ZIP", rows: 41548, source: "ZipCode_BG1", version: "v2026.01" },
    { id: 17, name: "Property Deductible Factors", lob: "Commercial Property", keys: "State + Ded + Coverage", rows: 2870, source: "DeductFactors", version: "v2026.01" },
    { id: 18, name: "Property PPC Table", lob: "Commercial Property", keys: "State + County + PPC", rows: 7501, source: "PPC", version: "v2026.01" },
    { id: 19, name: "ISO Class Descriptions", lob: "Commercial Property", keys: "Class Code", rows: 5246, source: "ISO_Class_Descr", version: "v2026.01" },
    { id: 20, name: "MPL Classifications", lob: "Professional Liability (MPL)", keys: "NAICS", rows: 604, source: "Classifications", version: "v2024.12" },
    { id: 21, name: "MPL ZIP Code", lob: "Professional Liability (MPL)", keys: "ZIP", rows: 57774, source: "ZipCode", version: "v2024.12" },
    { id: 22, name: "MPL Incurred Loss Bands", lob: "Professional Liability (MPL)", keys: "Incurred Loss", rows: 155, source: "IncLoss", version: "v2024.12" },
    { id: 23, name: "Cyber Helper Tables", lob: "Cyber", keys: "Multiple", rows: 184, source: "HelperTables", version: "v2026.05" },
  ].map(r => ({ ...r, active: true }));
